insert into roles values(null, "ROLE_LEVEL_I_CATALOGER", "Level 1 Cataloger");
insert into roles values(null, "ROLE_LEVEL_II_CATALOGER", "Level 2 Cataloger");
insert into roles values(null, "ROLE_LEVEL_III_CATALOGER", "Level 3 Cataloger");

update user_roles set role_id = (select id from roles where name = 'ROLE_LEVEL_I_CATALOGER') where role_id = (select id from roles where name = 'ROLE_CATALOG_DATABASE_ADMIN');
update user_roles set role_id = (select id from roles where name = 'ROLE_LEVEL_III_CATALOGER') where role_id = (select id from roles where name = 'ROLE_CATALOG_DATABASE_USER');

delete from roles where name = 'ROLE_CATALOG_DATABASE_USER';
delete from roles where name = 'ROLE_CATALOG_DATABASE_ADMIN';
