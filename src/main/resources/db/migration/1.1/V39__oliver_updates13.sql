ALTER TABLE reading_room_object_parts drop COLUMN date_century;

create table `reading_room_part_centuries` (
...
CREATE INDEX reading_room_part_centuries_idx1 ON reading_room_part_centuries(part_id);
