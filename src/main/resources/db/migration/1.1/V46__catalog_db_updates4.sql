alter table reading_room_objects 
	change binding_width binding_width FLOAT, 
	change binding_height binding_height FLOAT, 
	change binding_depth binding_depth FLOAT;
...
select 
	...
	group_concat(DISTINCT p.support ORDER BY p.support SEPARATOR ' and ') as support,    
