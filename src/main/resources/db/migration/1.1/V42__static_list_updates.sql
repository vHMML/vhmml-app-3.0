CREATE TABLE reading_room_scripts (
    `id` INT(11) NOT NULL AUTO_INCREMENT,    
    `name` VARCHAR(100),
     PRIMARY KEY(`id`)
) ENGINE=InnoDb AUTO_INCREMENT=11235 DEFAULT CHARSET=utf8;

CREATE TABLE reading_room_writing_systems (
    `id` INT(11) NOT NULL AUTO_INCREMENT,    
    `name` VARCHAR(100),
     PRIMARY KEY(`id`)
) ENGINE=InnoDb AUTO_INCREMENT=11235 DEFAULT CHARSET=utf8;
...
insert into reading_room_scripts values(null, 'Ancient Roman');
...
insert into reading_room_scripts values(null, 'Carolingian ');
...
insert into reading_room_scripts values(null, 'Cursive');
...
insert into reading_room_scripts values(null, 'Gothic Cursive');
...
insert into reading_room_scripts values(null, 'Humanist');
insert into reading_room_scripts values(null, 'Insular');
...
insert into reading_room_scripts values(null, 'Later Roman Cursive');
...
insert into reading_room_scripts values(null, 'New Abassic style');
...
insert into reading_room_scripts values(null, 'Old Roman Cursive');
...
insert into reading_room_writing_systems values(null, 'Gǝʿǝz');
...
insert into reading_room_institutions values(null, 'Heritage Malta  (Valletta, Malta)');
