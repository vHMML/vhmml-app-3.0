...
select 
    ...
    o.icon_name,
    ifnull(o.support, group_concat(distinct p.support_imported separator '; ')) as support,
    o.capture_date,
    o.bibliography,
	o.common_name,	
    concat(ifnull(o.notes, ''), ifnull(group_concat(distinct p.part_notes), ''), ifnull(group_concat(distinct cnt.item_notes), '')) as notes,
    o.active,
