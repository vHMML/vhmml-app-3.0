-- changing the ids on archival data so we need to remove archival objects in Dev & Test
delete from reading_room_facsimile_urls where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_alternate_surrogates where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_bib_urls where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_contributors where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_extents where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_features where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_genres where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_object_subjects where reading_room_object_id in(select id from reading_room_objects where object_type = 'ARCHIVAL_OBJECT');
delete from reading_room_archival_content;
delete from reading_room_archival_data_centuries;
delete from reading_room_archival_data_languages;
delete from reading_room_archival_contributors;
delete from reading_room_archival_data;
delete from reading_room_objects where object_type = 'ARCHIVAL_OBJECT';

alter table reading_room_objects drop column archival_data_id;
alter table reading_room_archival_data add column reading_room_object_id int(11);
alter table reading_room_archival_data add column century_imported varchar(255);
alter table reading_room_archival_data AUTO_INCREMENT = 500000;
