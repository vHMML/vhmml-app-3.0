...
select 
	...
	concat(group_concat(distinct ad.writing_system), ', ', group_concat(distinct ifnull(ac.writing_system, ifnull(p.writing_system, p.writing_system_imported)))) as writing_systems,		    		    
