...
<ul>
	<li><span class="rrHelpSubheading">Keyword</span> This field works sort of like a Google search. Capitalized and lowercase characters are treated equally. Wildcard searching is allowed using an * (asterisk) to represent zero or more unknown characters. Exact phrase searching using quotation marks/double quotes ( " " ) will limit results by finding words and spaces together. Words must be spelled exactly or else they won't be found if using double quotes.</li>
	<li><span class="rrHelpSubheading">Keyword search limitations </span>  Keyword is designed to work with at least 3 entered characters. Searches with fewer than 3 letters will probably yield suboptimal results. Keyword search does <i>not</i> currently support Boolean searching (using AND/OR/NOT operators).</li>
