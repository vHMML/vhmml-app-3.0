	...
	<div class="formSection">	
		...
		<div class="row">
			<div class="col-sm-3 objectIcon">
				...
				<c:if test="${folioObject.iconName != null}">	
			...
			<div class="col-sm-6">
				...
				<div>Object ID: ${folioObject.id}</div>
				<div>Permanent link: <a target="_blank" href="https://${configValues['permalink.url'].value}/folio/view/${folioObject.id}">https://${configValues['permalink.url'].value}/folio/view/${folioObject.id}</a></div>
			</div>
		</div>
		...
		<vhmml:input label="Folio Object Number" fieldName="folioObjectNumber" cssClass="projectNumber" required="true" />				
