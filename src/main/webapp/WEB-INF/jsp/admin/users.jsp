...
<div class="row">
	...
	<div class="table-responsive">		
		<table id="usersTable" class="table table-striped table-hover table-nowrap">				
			<thead>
				<tr>
					<th class="col-lg-2 user-admin-registerTime"><a href="javascript:sort('registerTime');">Register Date</a></th>
					<th class="col-lg-2 user-admin-username"><a href="javascript:sort('username');">Email</a></th>
					<th class="col-lg-2 user-admin-lastName"><a href="javascript:sort('lastName');">User's Name</a></th>
					<th class="col-lg-2 user-admin-lastLogin"><a href="javascript:sort('lastLogin');">Last Login</a></th>
					<th class="col-lg-1 user-admin-enabled"><a href="javascript:sort('enabled');">Enabled</a></th>
					<th class="col-lg-1 user-admin-unlock"><a href="javascript:sort('accountLocked');">Unlocked</a></th>
