...
<p>
	...
	<a href="#ACCESSIBILITY">UNIVERSAL DESIGN</a>&nbsp;|&nbsp;
...
<p>If you are <a href="${pageContext.request.contextPath}/login">signed in</a> to <span class="redtext italicstext">v</span>HMML and are not active on any of the pages for
 ${pageContext.session.maxInactiveInterval / 60  } minutes, the system will inquire whether you still want to remain signed in. If you still do not respond, the system will automatically sign you out to maintain security.</p>

<h3 id="SEARCHING" class="rrHelp jumptarget-breadcrumbs">Searching <span class="redtext italicstext">v</span>HMML Reading Room</h3>
<span class="redtext italicstext">v</span>HMML Reading Room is a successor to HMML&#8217;s previous online catalog, <a href="http://www.vhmml.us/research2014/catalog/text_search.asp" target="_blank">OLIVER</a>, and image database, <i><a href="http://cdm.csbsju.edu/" target="_blank">Vivarium</a></i>. <span class="redtext italicstext">v</span>HMML Reading Room 
...
the</em> <a href="http://www.vhmml.us/research2014/catalog/text_search.asp" target="_blank">Legacy Catalog</a> <em>or see the</em> <a href="${pageContext.request.contextPath}/readingRoom/uncatalogedCollections">list of uncataloged collections</a>.</p> 
...
<ul>
  <li><span class="rrHelpSubheading">Keyword</span> This field works sort of like a Google search, in that various fields are searched. Capitalized and lowercase characters are treated equally. Wildcard searching is allowed using an * (asterisk) to represent zero or more unknown characters. Exact phrase searching using quotation marks/double quotes ( "" ) will limit results by finding words and spaces together. Words must be spelled exactly or else they won't be found if using double quotes.</li>
  <%--The ? character (question mark) represents an unknown character. --%>
  <li><span class="rrHelpSubheading">Keyword limitations </span> This release does not yet support Boolean searching (using AND/OR/NOT operators).  Keyword search does <i>not</i> search the following fields: Access Restrictions, Condition Notes, Current Status, Date Range, Dimensions, Extent, Native Date Precise, Processed By, Rights, Surrogate Format, etc.</li>
...
<ul class="withHeading">
  ...
  <li><span class="rrHelpSubheading">Native script </span> The abbreviation  <i>NS</i> indicates a field with native script. For example, the field <i>Title NS </i>  displays the title in native script. </li>
</ul>
...
or assistive technology was considered from the very beginning. Part of the goal was to try to make the interface more flexible to be accessible for all kinds of users, especially for <a href="${pageContext.request.contextPath}/readingRoom">Reading Room</a> and <a href="${pageContext.request.contextPath}/folio">Folio</a>. 
We provided point of need context-sensitive Help on all modules, with <a href="${pageContext.request.contextPath}/contact">contact email</a> available from any page from a contact link in the footer. <a href="http://www.hmml.org/" target="_blank">HMML</a> realizes that accessibility and Universal Design are goals 
...
<h3 id="SYRIAC" class="rrHelp jumptarget-breadcrumbs">A special note about Syriac</h3>	
	If you see a series of small boxes where you expect to see Syriac characters, here are suggestions for various platforms:
 			<ul>
				...
				If the fonts were installed correctly, instead of the incomprehensible rectangles you should now see Syriac characters.<br />
				<br />
...
<h3 class="rrHelp">Known issues</h3>
		<ul>
			...
			<li>The system does not currently save a record of your previous searches when you sign out or if you do not interact with the system for more than  ${pageContext.session.maxInactiveInterval / 60  } minutes. The next time you <a href="${pageContext.request.contextPath}/login">sign in</a>, you will need to re-create any previous searches. </li>
		</ul>
...
<p> If you are still having problems, <a href="${pageContext.request.contextPath}/contact">please contact us</a> and include a detailed description of the issue in addition to your browser type and version  along with your computer operating system version (e.g. Mac OS X 10.6, Windows 10 64-bit, etc.).</p>
<p>&nbsp;</p>
...
<noscript>
	<p>&nbsp;<span class="redtext italicstext">v</span>HMML Reading Room requires JavaScript in order to function correctly. Please turn JavaScript on in your browser settings.
