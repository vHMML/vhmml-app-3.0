...
<security:authorize ifAnyGranted="ROLE_ADMIN,ROLE_LEVEL_I_CATALOGER,ROLE_LEVEL_II_CATALOGER,ROLE_LEVEL_III_CATALOGER">
		<a href="${pageContext.request.contextPath}/catalogDatabase/add">
			<button type="button" class="btn btn-md catalog-database">Add Record</button>
		</a>
		
		<security:authorize ifAnyGranted="ROLE_ADMIN">
			<div class="btn-group">
				<button type="button" class="btn btn-md catalog-database dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					...
					<li><a href="${pageContext.request.contextPath}/catalogDatabase/authorityList/SUBJECT?selectedMenuItem=list">Subjects</a></li>						
			...
			<a id="exportButton" href="${pageContext.request.contextPath}/catalogDatabase/export">
				<button type="button" class="btn btn-md catalog-database">Export Data</button>
			</a>			
			
			<a href="${pageContext.request.contextPath}/catalogDatabase/import">
				<button type="button" class="btn btn-md catalog-database">Import Data</button>
			</a>
		</security:authorize>			
			
		<div class="btn-group">
			<button type="button" class="btn btn-md catalog-database dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				Cataloger Resources <span class="caret"></span>
			</button>
			<ul class="dropdown-menu dropdown-menu-right">
				...
				<li><a href="${pageContext.request.contextPath}/catalogDatabase/csv">Opening an exported CSV file</a></li>
				<li><a href="${pageContext.request.contextPath}/catalogDatabase/contact">Questions? Contact a Curator or Librarian</a></li>
			</ul>
		</div>
		
		<button type="button" class="btn btn-md btn-backToResults catalog-database"><span class="glyphicon glyphicon-share-alt flipHorizontal"></span>Results</button>
