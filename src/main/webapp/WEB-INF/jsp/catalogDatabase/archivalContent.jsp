		...
		<div class="contentItem" data-item-index="${loopStatus.index}" data-item-id="${contentItem.id}">
			...
			<div class="formSection">
				...
				<div class="groupedFields">
					...
					<vhmml:input label="Item location, if in a volume" fieldName="spanOfFolios" listName="archivalData.content" listIndex="${loopStatus.index}" />	
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<form:input path="archivalData.content[${loopStatus.index}].beginDate" cssClass="form-control dateYear integersOnly" maxlength="5" data-list-name="archivalData.content" data-field="beginDate" data-list-index="${loopStatus.index}"/>
						
						<label for="archivalData.content[${loopStatus.index}].endDate" class="inlineLabel">End</label>							
						<form:input path="archivalData.content[${loopStatus.index}].endDate" class="form-control dateYear integersOnly" maxlength="5" data-list-name="archivalData.content" data-field="endDate"  data-list-index="${loopStatus.index}"/>
				...
				<security:authorize ifNotGranted="ROLE_ADMIN,ROLE_LEVEL_I_CATALOGER">
					...
					<form:hidden path="archivalData.content[${loopStatus.index}].archivalContentItemCondition"/>					
					<form:hidden path="archivalData.content[${loopStatus.index}].bibliography"/>	
					<c:set var="itemBibClass" value=""/>			
				</security:authorize>
				
				<vhmml:input label="Item Condition" fieldName="archivalContentItemCondition" listName="archivalData.content" listIndex="${loopStatus.index}" deprecated="true"
				...
				<vhmml:input label="Decoration/Illustration" fieldName="archivalContentDecoration" listName="archivalData.content" listIndex="${loopStatus.index}" textarea="true" cssClass="ckEditor"/>								
