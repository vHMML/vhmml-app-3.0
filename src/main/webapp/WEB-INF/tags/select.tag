...
<%@ attribute name="optionDependentListProperty" required="false" rtexprvalue="true" %>
...
<div class="form-group ${formGroupClass}">
	...
	<div class="col-sm-${fieldColumns}">	
		...
		<form:select path="${completeFieldName}" cssClass="form-control col-sm-${fieldColumns} ${cssClass}" data-dependent-list="${optionDependentListProperty}" data-value-property="${optionValueProperty}" data-error-placement="${errorPlacement}" data-field="${fieldName}" data-list-name="${listName}" data-list-index="${listIndex}">
