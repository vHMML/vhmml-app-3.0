...
<div class="form-group ${cssClass}">
	...
	<div class="col-sm-9">
		...
		<form:input path="${completeFieldName}Height" cssClass="form-control dimension-input height positiveDecimalsOnly maxValue" data-list-name="${listName}" data-list-index="${listIndex}" data-max-value="${maxValue}" /><span class="dimension-label">x</span>
		<label class="inlineLabel">Width</label>
		<form:input path="${completeFieldName}Width" cssClass="form-control dimension-input width positiveDecimalsOnly maxValue" data-list-name="${listName}" data-list-index="${listIndex}" data-max-value="${maxValue}" />
		
		<c:if test="${includeDepth}">
			<span class="dimension-label">x</span>
			<label class="inlineLabel">Thickness</label>
			<form:input path="${completeFieldName}Depth" cssClass="form-control dimension-input depth positiveDecimalsOnly maxValue" data-list-name="${listName}" data-list-index="${listIndex}" data-max-value="${maxValue}" />
		</c:if>
