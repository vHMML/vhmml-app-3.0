...
public class AppStartupListener implements ServletContextListener {
	...
	private void initializeElasticSearch(ServletContext servletContext) {
		try {			
			...
			LOG.error("Unexpected Exception while initializing search index in AppStartupListener, search index may not be initialized.", e);
		}	
	}
	...
	private void createInitalUser() {
		...
		if(adminUser == null) {
			...
			adminUser.setPassword("vhmmlAdminNoR01es!");
