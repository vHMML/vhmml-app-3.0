...
public class ApplicationConfigServiceImpl implements ApplicationConfigService {
    ...
    public List<ConfigurationValue> getAll() {
    	return Lists.newArrayList(configurationRepository.findAllByOrderByKeyAsc());
    }
    
    public Map<String, ConfigurationValue> getAllAsMap() {
    	Map<String, ConfigurationValue> configValuesMap = new LinkedHashMap<String, ConfigurationValue>();
