...
@Repository
public interface ReadingRoomImageRepository extends CrudRepository<Image, Long>, BatchSaveRepository<Image> {

	public static final String DELETE_BY_IMPORT_SOURCE_QUERY = "delete from reading_room_images where reading_room_content_id in(select c.id from reading_room_content c join reading_room_object_parts p on c.reading_room_object_part_id = p.id join reading_room_objects o on p.reading_room_object_id = o.id where o.data_source = ?1)";
