...
public interface ReadingRoomOverviewRepository extends CrudRepository<ReadingRoomObjectOverview, Long> {
	...
	public static final String OBJECT_OVERVIEW_QUERY = "select \r\n" + 
			...
			"	group_concat(distinct cnt.contents_detail order by cnt.contents_detail separator '; ') as contents_detail, \r\n" +
			...
			"	ad.collection_fond as archival_collection_fond,\r\n" +
			"	ad.series as archival_series,\r\n" +
			"	ad.sub_series as archival_sub_series,\r\n" +
			"	ad.sub_sub_series as archival_sub_sub_series,\r\n" +				
		    ...
		    "	group_concat(DISTINCT bib_urls.link_text SEPARATOR '; ') as external_biblography,\r\n" +
		    "	group_concat(DISTINCT p.printing_statement SEPARATOR '; ') as printing_statement\r\n" +
			"from reading_room_objects o left outer join\r\n" + 
			"	reading_room_object_bib_urls bib_urls on o.id = bib_urls.reading_room_object_id left outer join\r\n" +
			...
			"	reading_room_archival_contributors archival_associated_names on archival_associated_names.archival_data_id = ad.id left outer join\r\n" +
