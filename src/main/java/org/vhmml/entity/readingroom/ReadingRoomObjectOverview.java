...
public class ReadingRoomObjectOverview implements Identifiable {
	...
	@Column(name = "archival_collection_fond")
	private String archivalCollectionFond;
	
	@Column(name = "archival_series")
	private String archivalSeries;
	
	@Column(name = "archival_sub_series")
	private String archivalSubSeries;
	
	@Column(name = "archival_sub_sub_series")
	private String archivalSubSubSeries;	
	...
	@Column(name = "external_biblography")
	private String externalBiblography;
	...
	@Transient
	private boolean myListSaved;
	
	@Transient
	private Date myListSavedDate;
	
	@Transient
	private String myListSavedDateDisplay;
	
	public String getMyListSavedDateDisplay() {
		return myListSavedDateDisplay;
	}

	public void setMyListSavedDateDisplay(String myListSavedDateDisplay) {
		this.myListSavedDateDisplay = myListSavedDateDisplay;
	}

	public boolean isMyListSaved() {
		return myListSaved;
	}

	public void setMyListSaved(boolean myListSaved) {
		this.myListSaved = myListSaved;
	}

	public Date getMyListSavedDate() {
		return myListSavedDate;
	}

	public void setMyListSavedDate(Date myListSavedDate) {
		this.myListSavedDate = myListSavedDate;
	}
	...
	public String getExternalBiblography() {
		return externalBiblography;
	}

	public void setExternalBiblography(String externalBiblography) {
		this.externalBiblography = externalBiblography;
	}

	public String getArchivalCollectionFond() {
		return archivalCollectionFond;
	}

	public void setArchivalCollectionFond(String archivalCollectionFond) {
		this.archivalCollectionFond = archivalCollectionFond;
	}

	public String getArchivalSeries() {
		return archivalSeries;
	}

	public void setArchivalSeries(String archivalSeries) {
		this.archivalSeries = archivalSeries;
	}

	public String getArchivalSubSeries() {
		return archivalSubSeries;
	}

	public void setArchivalSubSeries(String archivalSubSeries) {
		this.archivalSubSeries = archivalSubSeries;
	}

	public String getArchivalSubSubSeries() {
		return archivalSubSubSeries;
	}

	public void setArchivalSubSubSeries(String archivalSubSubSeries) {
		this.archivalSubSubSeries = archivalSubSubSeries;
	}
	...
	public boolean getPublicManifest() {
