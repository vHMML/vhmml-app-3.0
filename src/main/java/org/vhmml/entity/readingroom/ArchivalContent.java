...
public class ArchivalContent extends Content implements Identifiable {
	...
	private String archivalContentItemCondition;
	...
	private String archivalContentDecoration;
	...
	public String getArchivalContentItemCondition() {
		return archivalContentItemCondition;
	}

	public void setArchivalContentItemCondition(String archivalContentItemCondition) {
		this.archivalContentItemCondition = archivalContentItemCondition;
	}
	...
	public String getArchivalContentDecoration() {
		return archivalContentDecoration;
	}

	public void setArchivalContentDecoration(String archivalContentDecoration) {
		this.archivalContentDecoration = archivalContentDecoration;
	}
