...
@Component
public class ListingDataJsonProcessor implements ItemProcessor<ReadingRoomObject, String> {
	...
	public String process(ReadingRoomObject readingRoomObject) throws Exception {
		Gson gson = new Gson();
		return gson.toJson(dataPortalService.createSingleListingDataJsonUsingObject(readingRoomObject));
	}
