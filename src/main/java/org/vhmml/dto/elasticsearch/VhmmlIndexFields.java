...
public class VhmmlIndexFields {
	...
	private VhmmlIndexFields() {
		...
		referenceFields.add(new IndexedField("authors"));		
		referenceFields.add(new IndexedField("blogTitle"));
		referenceFields.add(new IndexedField("bookTitle"));
		referenceFields.add(new IndexedField("conferenceName"));
		referenceFields.add(new IndexedField("date"));
		referenceFields.add(new IndexedField("dictionaryTitle"));
		referenceFields.add(new IndexedField("displayTitle"));
		referenceFields.add(new IndexedField("encyclopediaTitle"));
		referenceFields.add(new IndexedField("id"));
		referenceFields.add(new IndexedField("institution"));
		referenceFields.add(new IndexedField("itemType"));
		referenceFields.add(new IndexedField("manuscriptType"));
		referenceFields.add(new IndexedField("place"));
		referenceFields.add(new IndexedField("proceedingsTitle"));
		...
		referenceFields.add(new IndexedField("studio"));
		referenceFields.add(new IndexedField("title"));
		referenceFields.add(new IndexedField("university"));
		referenceFields.add(new IndexedField("author"));
		referenceFields.add(new IndexedField("otherContributors"));
		...
		readingRoomFields.add(new IndexedField("externalBiblography"));
		readingRoomFields.add(new IndexedField("contentsDetail"));
		...
		readingRoomFields.add(new IndexedField("decoration"));
		readingRoomFields.add(new IndexedField("support"));
		readingRoomFields.add(new IndexedField("partOtherContributors"));
		readingRoomFields.add(new IndexedField("partOtherContributorsDisplay"));		
		...
		readingRoomFields.add(new IndexedField("archivalContributors"));
		readingRoomFields.add(new IndexedField("archivalContributorsDisplay"));
		readingRoomFields.add(new IndexedField("archivalCreators"));
		readingRoomFields.add(new IndexedField("archivalTitle"));
		readingRoomFields.add(new IndexedField("archivalContentDescription"));
		readingRoomFields.add(new IndexedField("archivalContentNotes"));
		readingRoomFields.add(new IndexedField("archivalBibliography"));
		readingRoomFields.add(new IndexedField("archivalScopeContent"));
		readingRoomFields.add(new IndexedField("archivalCustodialHistory"));
		readingRoomFields.add(new IndexedField("archivalHistoricalNote"));		
		readingRoomFields.add(new IndexedField("archivalCollectionFond"));
		readingRoomFields.add(new IndexedField("archivalSeries"));
		readingRoomFields.add(new IndexedField("archivalSubSeries"));
		readingRoomFields.add(new IndexedField("archivalSubSubSeries"));
		...
		readingRoomFields.add(new IndexedField("printingStatement"));
		...
		objectSaveFields.add(new IndexedField("hmmlProjectNumber", "string", "small_ngram_analyzer", fieldVariants));		
	}
	...
	public static boolean containsDateTypeField(List<IndexedField> fields) {
		boolean contains = false;
		
		if (CollectionUtils.isNotEmpty(fields)) {
			for (IndexedField field : fields) {
				if (field.getType().equals(DATE_TYPE)) {
					contains = true;
					break;
				}
			}
